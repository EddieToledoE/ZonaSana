...
function Home() {
    ...
    return(
       <section className="Home">
         ...
         <Grafica/>
         <Bar/>
            <div className="Proveedores-Inventario">
                <div className="Proveedores">
               <div className="a-container">
                <a className="a-prov">Proveedores</a>
                </div>
                    <div className="Proveedores-inf">
                        ...
                        <a id="provedores-n" className="numero-provedores">
                            31
                        </a>
                        <a className="a-numero-p">Numero de proveedores</a>
                    </div>
                </div>
